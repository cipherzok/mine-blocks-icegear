renderers.armor.Q_Leggings = function (b) {
...
m["renderers.armor.Q_Leggings"] = renderers.armor.Q_Leggings
renderers.armor.Q_Leggings.__name__ = "renderers.armor.Q_Leggings"
renderers.armor.Q_Leggings.__super__ = renderers.Q_Base
renderers.armor.Q_Leggings.prototype = z(renderers.Q_Base.prototype, {
    update: function () {
        if (null != this.itemData && null != this.frames.h[this.itemData[0]]) {
            js.Boot.__cast(this.entity, QuadPoolEntity_MatrixState).currentMatrix.translate(-.275, -.45).multiply(this.matrix1.values);
            var b = this.entity;
            var a = 1;
            ...
            js.Boot.__cast(this.entity, QuadPoolEntity_MatrixState).currentMatrix.reset().translate(-.275, -.45).multiply(this.matrix2.values);
            b = this.entity;
    ...
    __class__: renderers.armor.Q_Leggings
})