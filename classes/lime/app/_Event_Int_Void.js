lime.app._Event_Int_Void = function () {
    this.canceled = !1;
    this.__listeners = [];
    this.__priorities = [];
    this.__repeat = [];
}
m["lime.app._Event_Int_Void"] = lime.app._Event_Int_Void
lime.app._Event_Int_Void.__name__ = "lime.app._Event_Int_Void"
lime.app._Event_Int_Void.prototype = {
    add: function (b, a, c) {
        null == c && (c = 0);
        null == a && (a = !1);
    ...
    has: function (b) {
        for (var a = 0, c = this.__listeners; a < c.length;) if (c[a++] == b) return !0;
        return !1;
    },
    remove: function (b) {
    ...
    __class__: lime.app._Event_Int_Void
}