lemongine.shader.BasicFont = function () {}
m["lemongine.shader.BasicFont"] = lemongine.shader.BasicFont
lemongine.shader.BasicFont.__name__ = "lemongine.shader.BasicFont"
lemongine.shader.BasicFont.getShader = function (b) {
    if (null == b || b == lemongine.shader.BlendMode.ADD) b = lemongine.shader.BlendMode.NORMAL;
    if (!lemongine.shader.BasicFont.shaders.exists(b)) {
        var a = new lemongine.ShaderProgram("lemongine.shader.BasicFont." + fa[b.__enum__].__constructs__[b._hx_index]._hx_name, lemongine.shader.BasicFont.getFragmentShader(b), lemongine.shader.BasicFont.getVertexShader());
        ...
        lemongine.shader.BasicFont.shaders.set(b, a);
    }
    return lemongine.shader.BasicFont.shaders.get(b);
}
lemongine.shader.BasicFont.getFragmentShader = function (b) {
...
lemongine.shader.BasicFont.getVertexShader = function () {
...
lemongine.shader.BasicFont.shaders = new haxe.ds.EnumValueMap()